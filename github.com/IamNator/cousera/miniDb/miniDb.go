...
func actOnUserInput(rawUserInput []string, user_created_animal_list map[string]Animal) error {
	...
	switch rawUserInput[0] {

	case "newanimal":
		user_created_animal_list[rawUserInput[1]], err = createAnimal(rawUserInput[1], rawUserInput[2])
		if err != nil {
			return err
		}
		fmt.Println("Created it!")
	case "query":
		err = query(rawUserInput[1], rawUserInput[2], user_created_animal_list)
		if err != nil {
			return err
		}
	case "help":
